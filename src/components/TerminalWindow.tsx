...
const SCRIPT: Step[] = [
  ...
  { type: "output",       text: "Node.js/  PostgreSQL/  C++/  Figma/  Security/  Product-Design/", dim: true },
  { type: "blank" },
  { type: "pause",        ms: 140 },

  { type: "typeCommand",  text: "ls projects/" },
  { type: "pause",        ms: 100 },
  { type: "output",       text: "Ladybird/   Opus/   Strata/   Cipher/" },
  { type: "blank" },
  { type: "pause",        ms: 80 },
  { type: "output",       text: "  Ladybird →  open source browser engine · C++ contributor", accent: true },
  { type: "output",       text: "  Opus     →  iOS task manager · momentum-based · beta", dim: true },
